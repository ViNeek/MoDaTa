...
public class AndroidPowerCollector implements PowerCollector {
    ...
    private static final String POWER_CALCULATOR_CLASS = "com.android.internal.os.PowerCalculator";
    ...
    private static AppCompatActivity parent_;
    ...
    public static double getBatteryCapacity(Context c) {
        try {
            Class x = Class.forName(POWER_PROFILE_CLASS);

            mPowerProfile_ = Class.forName(POWER_PROFILE_CLASS).getConstructor(Context.class).newInstance(c);
            double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getAveragePower", String.class).invoke(mPowerProfile_, PowerProfileConstants.POWER_BATTERY_CAPACITY);
            //double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getBatteryCapacity", String.class).invoke(mPowerProfile_, null);
    ...
    public static double getWifiOnConsumption(Context c) {
        try{
            Class x = Class.forName(POWER_PROFILE_CLASS);

            mPowerProfile_ = Class.forName(POWER_PROFILE_CLASS).getConstructor(Context.class).newInstance(c);
            double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getAveragePower", String.class).invoke(mPowerProfile_, PowerProfileConstants.POWER_WIFI_ON);
    ...
    public static double getWifiActiveConsumption(Context c) {
        try {
            Class x = Class.forName(POWER_PROFILE_CLASS);

            mPowerProfile_ = Class.forName(POWER_PROFILE_CLASS).getConstructor(Context.class).newInstance(c);
            double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getAveragePower", String.class).invoke(mPowerProfile_, PowerProfileConstants.POWER_WIFI_ACTIVE);
    ...
    public static double getRadioOnConsumption(Context c) {
        try{
            Class x = Class.forName(POWER_PROFILE_CLASS);

            mPowerProfile_ = Class.forName(POWER_PROFILE_CLASS).getConstructor(Context.class).newInstance(c);
            double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getAveragePower", String.class).invoke(mPowerProfile_, PowerProfileConstants.POWER_RADIO_ON);
    ...
    public static double getRadioActiveConsumption(Context c) {
        try{
            Class x = Class.forName(POWER_PROFILE_CLASS);

            mPowerProfile_ = Class.forName(POWER_PROFILE_CLASS).getConstructor(Context.class).newInstance(c);
            double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getAveragePower", String.class).invoke(mPowerProfile_, PowerProfileConstants.POWER_RADIO_ACTIVE);
    ...
    private void load(){
        try{
            ...
            byte[] data = (byte[])Class.forName(M_BATTERY_INFO_CLASS).getDeclaredMethod("getStatistics", null)
    ...
    public void processApplicationUsage(String label){
        ...
        parent_ = ModataActivity.getActivityInstance();
        try {
            Class x = Class.forName(POWER_PROFILE_CLASS);
            Object IBinderRef = Class.forName("android.os.ServiceManager").getDeclaredMethod("getService", String.class).invoke(null, "batterystats");
            Log.i("IBinder", "Is null = " + (IBinderRef == null));
            mBatteryInfo_ = Class.forName("com.android.internal.app.IBatteryStats$Stub").getDeclaredMethod("asInterface",
                    ...
                    .getDeclaredMethod("getService", String.class).invoke(null, "batterystats"));
            mPowerProfile_ = Class.forName(POWER_PROFILE_CLASS).getConstructor(Context.class).newInstance(parent_);
            double dou = (double) Class.forName(POWER_PROFILE_CLASS).getDeclaredMethod("getAveragePower", String.class).invoke(mPowerProfile_, "wifi.scan");
            Log.i("Reflection", "Double : " + dou);
            Log.i("Reflection", "Is there" + (mBatteryInfo_ == null));
            ...
            for (Method method : methods) {
                ...
                for ( TypeVariable<Method> arg : args ) {
                    Log.i("Parameter ", "name : " + arg.getName() );
                }
                Log.i("Method ", "name : " + method.getName() );
            }
            load();
            Log.i("After Load ", "done : ");
            return;
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SecurityException e) {
